...
# learning rate
param_scheduler = [
    dict(type="LinearLR", start_factor=1.0e-5, by_epoch=False, begin=0, end=30),
    dict(
...
model = dict(
    ...
    pretrained="work_dirs/cfg_base_copy/epoch_50.pth",
    # backbone
    backbone=dict(
    ...
    cfg=dict(
        ...
        tokenizer=dict(
            # guide_ratio=0.0,
            ckpt="work_dirs/my_base_tokenizer_copy/epoch_50.pth",
            encoder=dict(
                drop_rate=0.2,
                num_blocks=4,
                hidden_dim=512,
